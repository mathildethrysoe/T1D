...
riskfactors1 %>% 
    select(Diabetes, "Gender (female)", Age, "Diabetes duration", HbA1c, BMI, "Hip circumference", "Waist circumference", Tanner, SBP, DBP, Pulse, Retinopathy, Nephropathy, Cholesterol, LDL, HDL, Triglycerids, Alcohol, Smoking, Activity) %>% 
